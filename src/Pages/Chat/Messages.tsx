      ...
      <div className="flex justify-center mb-4">
        <div className="flex flex-col items-center justify-center">
          ...
          <Link to={`/profile/${selectedUser?._id}`}>
            <Button className="h-8 my-2 bg-logo" variant="secondary">
              View profile
            </Button>
          </Link>
        </div>
              ...
              <div
                className={`p-2 rounded-lg max-w-xs break-words ${
                  msg.senderId === user?._id
                    ? "bg-gradient-to-tr from-blue-300 to-green-300 text-sky-900"
                    : "bg-gradient-to-bl from-blue-300 to-green-300 text-sky-900"
                }`}
              >
                {msg.message}
